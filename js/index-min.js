	...
	new Vue({
		...
		methods: {
			appendDialog: function(n) {
				var o = this;
				if ("object" === (void 0 === n ? "undefined" : _typeof(n)) && n.length > 0) n.forEach(
					function(t) {
					...
					if (null != n) {
						...
						}), i.nextAuthor ? this.appendDialog(i.nextAuthor) : this.msgChain.then(
							function() {
			...
			sendFriendMsg: function(t, n) {
				...
				return this.messages.push(c), h ? (this.markMsgSize(c), setTimeout(i), r(Math.min(100 * u,
					2e3)).then(function() {
